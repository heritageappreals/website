                                    ...
                                    <div class="product__single">
                                        <div class="product__box">
                                            <div class="product__thumb">
                                                <a href="https://heritageappreals.com/in/products/plain-280-gsm-gaze-trend-men-full-sleeves-fleece-hoodies.php"
                                                    class="img-wrapper">
                                                    <img class="img"
                                                        src="https://heritageappreals.com/in/products/img/productimages/kids-plain-t-shirt-1000x1000%20(1).webp"
                                                        alt="">
                                                    <img class="img secondary-img"
                                                        src="https://heritageappreals.com/in/products/img/productimages/kids-plain-t-shirt-1000x1000.webp"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div class="product__content--top">
                                                ...
                                                <h6 class="product__title mine__shaft-color f-700 mb-0"><a
                                                        href="https://heritageappreals.com/in/products/plain-280-gsm-gaze-trend-men-full-sleeves-fleece-hoodies.php">Plain
                                                        280 GSM Gaze Trend Men Full Sleeves Fleece Hoodies</a></h6>
                                            </div>
...
">Book Now</a></h5>
                                    ...
                                    <div class="product__single">
                                        <div class="product__box">
                                            <div class="product__thumb">
                                                <a href="https://heritageappreals.com/in/products/300gsm-cotton-fleece-hoodie-for-men.php"
                                                    class="img-wrapper">
                                                    <img class="img"
                                                        src="https://heritageappreals.com/in/products/img/productimages/customizable-300gsm-cotton-fleece-hoodie-for-men-1000x1000.webp"
                                                        alt="">
                                                    <img class="img secondary-img"
                                                        src="https://heritageappreals.com/in/products/img/productimages/customizable-300gsm-cotton-fleece-hoodie-for-men-1000x1000%20(3).webp"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div class="product__content--top">
                                                <!--<span class="cate-name">SAMSUNG</span>-->
                                                <h6 class="product__title mine__shaft-color f-700 mb-0"><a
                                                        href="https://heritageappreals.com/in/products/300gsm-cotton-fleece-hoodie-for-men.php">300gsm
                                                        cotton fleece full sleeves hoodie for <br>men
                                                    </a></h6>
                                            </div>
                                            <div class="product__content--rating d-flex justify-content-between">
                                                <div class="rating">
                                    ...
                                    <div class="product__single">
                                        <div class="product__box">
                                            ...
                                            <div class="product__content--top">
                                                <!--<span class="cate-name">SAMSUNG</span>-->
                                                <h6 class="product__title mine__shaft-color f-700 mb-0"><a
                                                        href="https://heritageappreals.com/in/products/men-plain-hoodie.php">Mens
                                                        Plain Hoodies
                                                    </a></h6>
                                            </div>
                                            <div class="product__content--rating d-flex justify-content-between">
                                    ...
                                    <div class="product__single">
                                        <div class="product__box">
                                            ...
                                            <div class="product__content--top">
                                                <span class="cate-name">Hoodies</span>
                                                <h6 class="product__title mine__shaft-color f-700 mb-0"><a
                                                        href="product-details.html">Fleece Plain Hoodie For Men
                                                    </a></h6>
                                            </div>
                                            <div class="product__content--rating d-flex justify-content-between">
                                                <div class="rating">
