                            ...
                            <div class="col-sm-12">
                                <div class="shop-banner-bg pt-60 pb-60 mb-50" data-background="img/bg/shop-banner-bg.jpg">
                                    <div class="collection-text">
                                        <h5 class="f-800"><a href="#" style="color: white;">Best Winter Apparel Manufacturer Company</a></h5>
                                    ...
                                    <div class="product__single">
                                        <div class="product__box">
                                            <div class="product__thumb">
                                                <a href="https://heritageappreals.com/in/products/plain-280-gsm-gaze-trend-men-full-sleeves-fleece-hoodies.php" class="img-wrapper">
                                                    <img class="img" src="https://heritageappreals.com/in/products/img/productimages/kids-plain-t-shirt-1000x1000%20(1).webp" alt="">
                                                    <img class="img secondary-img" src="https://heritageappreals.com/in/products/img/productimages/kids-plain-t-shirt-1000x1000.webp" alt="">
                                                </a>
                                            </div>
                                            <div class="product__content--top">
                                                <!--<span class="cate-name">SAMSUNG</span>-->
                                                <h6 class="product__title mine__shaft-color f-700 mb-0"><a href="https://heritageappreals.com/in/products/plain-280-gsm-gaze-trend-men-full-sleeves-fleece-hoodies.php">Plain 280 GSM Gaze Trend Men Full Sleeves Fleece Hoodies</a></h6>
                                            </div>
