                        ...
                        <div class="shop-bred pt-35 pb-35">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Full Sleeves Hooded MENS HOODIE
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="pro-img">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home5" role="tabpanel"
                                    ...
                                    <img src="img/productimages/olive-green-hdm-2-1000x1000.webp"
                                        class="img-fluid" alt=""></div>

                                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                                    <img src="img/productimages/olive-green-hdm-2-1000x1000.webp" class="img-fluid" alt="">
                                </div>
                            ...
                            <ul class="nav" id="myTab1" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab5" data-toggle="tab" href="#home5" role="tab"
                                        ...
                                        <img src="img/productimages/olive-green-hdm-2-1000x1000.webp" class="img-fluid" alt="" style="width: 110px; height: 110px;">
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-4 col-md-12 order-3 order-lg-2">
                        <div class="pro-content">
                            <span>Hoodies</span>
                            <h5 class="title"> Full Sleeves Hooded MENS HOODIE</h5>
                            ...
                            <div class="pro-code pt-25">
                                <ul>
                                    <li>SKU: <span>FW257518948818</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    ...
                                                    <p>Experience premium comfort and classic style with the Full Sleeves Olive Green Men’s Hoodie, thoughtfully designed for bulk buyers in fashion, retail, and promotional sectors. Proudly manufactured by Heritage Appreals, a trusted Ludhiana-based industry, this hoodie is tailored for businesses that prioritize quality, consistency, and style.

This hoodie features a clean and versatile plain olive green design, making it a go-to staple for any casualwear collection. The pullover style ensures a sleek silhouette with no zipper interruption, ideal for brands looking to add custom logos or prints. Whether for corporate giveaways, retail shelves, or university merchandise, this hoodie adapts to a variety of branding needs with ease.

Built for practicality, the full sleeves offer optimal coverage, while the attached hood adds extra warmth and a streetwear-inspired look. Its regular fit ensures all-day comfort, while ribbed cuffs and hem provide structure and shape retention over time. The hoodie is available in all sizes, catering to a wide demographic, and making it a scalable solution for businesses dealing in volume.

Ease of maintenance is another key advantage. With machine-wash compatibility, this hoodie is designed for repeated use without compromising on color or fabric quality. It's ideal for urban wearers, students, professionals, and anyone looking for a comfortable, dependable wardrobe option.

As a leading B2B manufacturer, Heritage Appreals also provides customization options on bulk orders, including tag branding, packaging, and fabric variation. Whether you're launching a new apparel line or expanding your current offerings, this hoodie delivers on both functionality and visual appeal.</div>
                                            </div>
                                            <!-- <div class="col-md-6">
                                                <div class="single-content mb-40">
                                ...
                                <div class="tab-pane fade" id="contact11" role="tabpanel"
                                    ...
                                    <div class="desc-content mt-60">
                                        <div class="row">
                                            <div class="col-md-12">
 <div class="single-content mb-40">
    <h5 class="title">Aarush Gill</h5>
    <p>Customers often compare these hoodies to top-tier brands. They’re shocked when we tell them the price!</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Saanvi Kohli</h5>
    <p>The fabric is thick but breathable. Great for layering without feeling stuffy.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Reyansh Malhotra</h5>
    <p>Easy to fold, store, and ship. That’s a big win for our online orders and fulfillment.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Tia Ahuja</h5>
    <p>Excellent for winter marketing kits. We added our brand patch and the results looked premium.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Yug Khatri</h5>
    <p>Buyers feel confident wearing it out or lounging at home. That comfort factor is unbeatable.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Avni Rana</h5>
    <p>The sleeves are the perfect length—not too short, not too baggy. Very well proportioned.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Shaurya Chadha</h5>
    <p>We did a campus tour pop-up and sold out of these hoodies in two cities. Absolute best-seller!</p>
</div>
