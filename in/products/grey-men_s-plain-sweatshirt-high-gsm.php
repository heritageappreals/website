...
<head>
    ...
    <title>Grey Men's Plain Sweatshirt Manufacturer | Heritage Appreals</title>
    <meta name="description" content="Best Grey Men's Plain Sweatshirt Manufacturer | Get ">
...
<?php include '../../assets/body.php';?>
                        ...
                        <div class="shop-bred pt-35 pb-35">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Grey Men's Plain Sweatshirt
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="pro-img">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home5" role="tabpanel"
                                    ...
                                    <img src="img/productimages/men-s-plain-sweatshirt-1000x1000.jpg"
                                        class="img-fluid" alt=""></div>

                                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                                    <img src="img/productimages/men-s-plain-sweatshirt-1000x1000.jpg" class="img-fluid" alt="">
                                </div>
                            ...
                            <ul class="nav" id="myTab1" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab5" data-toggle="tab" href="#home5" role="tab"
                                        ...
                                        <img src="img/productimages/men-s-plain-sweatshirt-1000x1000.jpg" class="img-fluid" alt="" style="width: 110px; height: 110px;">
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-4 col-md-12 order-3 order-lg-2">
                        <div class="pro-content">
                            ...
                            <h5 class="title">Grey Men's Plain Sweatshirt</h5>
  ...
  <li>Full Sleeve Sweatshirts for Everyday Comfort</li>
                            ...
                            <div class="pro-code pt-25">
                                <ul>
                                    <li>SKU: <span>FW51894881877</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    ...
                                                    <p>Upgrade your winter essentials with this classic grey full-sleeve sweatshirt for men, proudly manufactured by Heritage Appreals, Ludhiana. Designed with simplicity and versatility in mind, this plain sweatshirt is perfect for everyday wear, whether you’re heading out for errands, casual meetings, or simply lounging in style.

Crafted from premium-quality fabric, this sweatshirt offers a soft, comfortable feel with excellent warmth retention, making it ideal for cooler days. Its full-sleeve structure ensures maximum coverage, while the relaxed yet flattering fit provides ease of movement without compromising on style.

The timeless grey tone makes it easy to pair with any bottom—be it jeans, joggers, or chinos—making it a must-have wardrobe staple. Easy to wash and maintain, this piece from Heritage Appreals combines functionality, durability, and clean design in one seamless garment.</div>
                                            </div>
                                            <!-- <div class="col-md-6">
                                                <div class="single-content mb-40">
                                ...
                                <div class="tab-pane fade" id="contact11" role="tabpanel"
                                    ...
                                    <div class="desc-content mt-60">
                                        <div class="row">
                                            <div class="col-md-12">                                               
    <div class="single-content mb-40">
    <h5 class="title">Kabir Heer</h5>
    <p>Exactly what we needed for our winter merchandise — warm, well-fitted, and stylish.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Saanvi Puri</h5>
    <p>The hoodie's zip doesn’t snag or break — customers mentioned the reliability specifically.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Reyansh Boparai</h5>
    <p>Soft fleece inside and solid outer shell — a great dual-purpose product for both comfort and looks.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Meher Jassar</h5>
    <p>Perfect choice for corporate gifting. We got our logo printed and it looked really premium.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Yug Aheer</h5>
    <p>All color options are true to catalog photos. That accuracy helped us build trust with customers.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Tia Mundi</h5>
    <p>We sell a lot of hoodies, but this one had the least returns and most reorders. Says a lot!</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Dev Waraich</h5>
    <p>Material is breathable and wearable all day — no overheating or itching reported.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Avni Mahal</h5>
    <p>The design is clean and timeless — very easy to pair with both jeans and joggers.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Shaurya Kang</h5>
    <p>Our bulk order came packed beautifully. Every hoodie was ready to sell right out of the box.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Inaaya Sran</h5>
    <p>Hands down the most comfortable zip hoodie we've stocked — zero complaints, just appreciation.</p>
</div>
