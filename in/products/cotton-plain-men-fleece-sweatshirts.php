...
<?php include '../../assets/body.php';?>
                        ...
                        <div class="shop-bred pt-35 pb-35">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Cotton Plain Men Fleece Sweatshirts
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="pro-img">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home5" role="tabpanel"
                                    ...
                                    <img src="img/productimages/mens-fleece-sweatshirts-1000x1000.webp"
                                        class="img-fluid" alt=""></div>

                                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                                    <img src="img/productimages/mens-fleece-sweatshirts-1000x1000 (1).webp" class="img-fluid" alt="">
                                </div>

                                <div class="tab-pane fade" id="contact5" role="tabpanel" aria-labelledby="contact-tab5">
                                    <img src="img/productimages/mens-fleece-sweatshirts-1000x1000.webp" class="img-fluid" alt="">
                                </div>
                            </div>
                            ...
                            <ul class="nav" id="myTab1" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab5" data-toggle="tab" href="#home5" role="tab"
                                        ...
                                        <img src="img/productimages/mens-fleece-sweatshirts-1000x1000.webp" class="img-fluid" alt="" style="width: 110px; height: 110px;">
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab5" data-toggle="tab" href="#profile5" role="tab"
                                        aria-controls="profile5" aria-selected="false">
                                        <img src="img/productimages/mens-fleece-sweatshirts-1000x1000 (1).webp" class="img-fluid" alt="" style="width: 110px; height: 110px;">
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-4 col-md-12 order-3 order-lg-2">
                        <div class="pro-content">
                            ...
                            <h5 class="title">Cotton Plain Men Fleece Sweatshirts</h5>
  ...
  <li>Full Sleeve Sweatshirts for Everyday Comfort</li>
                            ...
                            <div class="pro-code pt-25">
                                <ul>
                                    <li>SKU: <span>FW5075894880589</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    ...
                                                    <p>Upgrade your winterwear inventory with the Cotton Plain Men Fleece Sweatshirt from Heritage Appreals, a leading Ludhiana-based manufacturer known for delivering high-quality garments at competitive prices. Designed for warmth, durability, and everyday style, this sweatshirt is a reliable essential for retailers, corporate clients, and bulk buyers across India.

Crafted using soft and breathable cotton fleece fabric, this pullover sweatshirt is tailored for comfort in cooler weather. The plain black design offers a versatile, timeless look that suits casual, work, or institutional wear. Its full sleeves and round neck ensure a snug yet comfortable fit, ideal for layering or standalone use.

This sweatshirt is perfect for customization, including screen printing, embroidery, or logo branding, making it ideal for corporate uniforms, college hoodies, promotional merchandise, and resale. Whether you need large volumes for a brand launch or a dependable product for year-round sales, this sweatshirt delivers unmatched value.</div>
                                            </div>
                                            <!-- <div class="col-md-6">
                                                <div class="single-content mb-40">
    ...
    <p>The stitching is super clean, and the fit is flattering. Definitely premium at an affordable price.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Avni Sethi</h5>
    <p>We’ve received zero complaints. Everyone’s happy with the quality and comfort of these sweatshirts.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Shaurya Brar</h5>
    <p>Very soft on the inside. My clients say it feels like their favorite blanket in hoodie form.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Tia Narang</h5>
    <p>The ribbed details around the sleeves and waist are excellent. Adds durability and style.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Kabir Anand</h5>
    <p>Everything about this product shows attention to detail—from the cut to the fabric finish.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Meher Cheema</h5>
    <p>Soft, warm, and doesn’t lose its charm even after many washes. It’s a winter staple.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Yug Ahuja</h5>
    <p>Minimalist, clean, and comfortable. Exactly what today’s customers are looking for.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Saanvi Chahal</h5>
    <p>We offer these sweatshirts as part of employee kits. Great response every single time!</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Dev Sahni</h5>
    <p>The feel is luxury-grade. I was surprised by the quality for this price range.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Inaaya Makkar</h5>
    <p>Many buyers complimented the material quality and stitching. It’s become a customer favorite.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Aarav Mann</h5>
    <p>These sweatshirts give a premium feel without looking flashy. Our audience loves subtle style.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Meher Gill</h5>
    <p>Fits true to size. The fabric feels fresh and soft even after weeks of regular use.</p>
</div>
