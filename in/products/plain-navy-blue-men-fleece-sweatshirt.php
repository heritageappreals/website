...
<?php include '../../assets/body.php';?>
                        ...
                        <div class="shop-bred pt-35 pb-35">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Plain Navy Blue Men Fleece Sweatshirt
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="pro-img">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home5" role="tabpanel"
                                    ...
                                    <img src="img/productimages/73-3-1000x1000.webp"
                                        class="img-fluid" alt=""></div>

                                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                                    <img src="img/productimages/73-7-1000x1000.webp" class="img-fluid" alt="">
                                </div>

                                <div class="tab-pane fade" id="contact5" role="tabpanel" aria-labelledby="contact-tab5">
                                    <img src="img/productimages/73-6-1000x1000.webp" class="img-fluid" alt="">
                                </div>
                            </div>
                            ...
                            <ul class="nav" id="myTab1" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab5" data-toggle="tab" href="#home5" role="tab"
                                        ...
                                        <img src="img/productimages/73-3-1000x1000.webp" class="img-fluid" alt="" style="width: 110px; height: 110px;">
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab5" data-toggle="tab" href="#profile5" role="tab"
                                        aria-controls="profile5" aria-selected="false">
                                        <img src="img/productimages/73-7-1000x1000.webp" class="img-fluid" alt="" style="width: 110px; height: 110px;">
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab5" data-toggle="tab" href="#contact5" role="tab"
                                        aria-controls="contact5" aria-selected="false">
                                        <img src="img/productimages/73-6-1000x1000.webp" class="img-fluid" alt=""style="width: 110px; height: 110px;">
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12 order-3 order-lg-2">
                        <div class="pro-content">
                            ...
                            <h5 class="title">Plain Navy Blue Men Fleece Sweatshirt</h5>
  ...
  <li>Full Sleeve Sweatshirts for Everyday Comfort</li>
                            ...
                            <div class="pro-code pt-25">
                                <ul>
                                    <li>SKU: <span>FW50758948805822</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    ...
                                                    <p>Presenting the Multicolor Plain Fleece Pullover Sweatshirt, a versatile winter essential manufactured by Heritage Appreals, a reputable Ludhiana-based industry specializing in high-quality fleece garments for B2B buyers, exporters, retail chains, and private label brands.

Crafted from premium-grade fleece fabric, this sweatshirt offers exceptional warmth, softness, and comfort—ideal for cold-weather markets. The fleece is durable and insulating, with a brushed inner layer that feels gentle against the skin, making it suitable for long hours of wear in both indoor and outdoor settings.

This pullover sweatshirt features a plain pattern that provides a clean canvas for custom printing, logo embroidery, or branding, making it an excellent choice for corporate giveaways, uniform programs, brand promotions, and casualwear lines. The multicolor options available allow businesses to offer a broader selection, catering to diverse fashion preferences.

With its relaxed fit and minimalist design, the sweatshirt suits both men and women and can easily be styled with jeans, joggers, or even layered under jackets. Its practicality and comfort make it popular among schools, colleges, offices, fitness centers, and casual fashion retailers.

At Heritage Appreals, we support complete OEM/ODM sweatshirt manufacturing, offering customizations such as GSM adjustment, color matching, sizing (S to XXL), labeling, and packaging solutions. We ensure bulk stock availability, strict quality checks, and fast turnaround times, helping B2B buyers scale efficiently.</div>
                                            </div>
                                            <!-- <div class="col-md-6">
                                                <div class="single-content mb-40">
    ...
    <p>We used them in our winter sale event. These sweatshirts were the first to sell out.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Avni Narula</h5>
    <p>So impressed with the colorfastness. Even the dark shades haven’t faded a bit.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Shaurya Ghuman</h5>
    <p>The sizing chart is accurate and makes ordering in bulk much easier for us.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Tia Lamba</h5>
    <p>The inner fleece doesn’t shed. Customers always appreciate that detail.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Kabir Virk</h5>
    <p>Absolutely loved by our college buyers — perfect fit, style, and price for youth.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Meher Brar</h5>
    <p>It’s become our best recommendation for new retailers. Always gets great feedback.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Yug Sekhon</h5>
    <p>Colors match the photos exactly. Very important for online listings.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Saanvi Sidhu</h5>
    <p>Soft, smart, and well-stitched. We haven’t received a single complaint yet.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Dev Makkar</h5>
    <p>Excellent fabric stretch without sagging. Fits great on all body types.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Inaaya Bedi</h5>
    <p>Everything from packaging to product delivery was seamless. Heritage Appreals always delivers!</p>
</div>
