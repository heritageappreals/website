...
<head>
    ...
    <title>Navy Blue Fleece Man Hoodies | Heritage Appreals Ludhiana</title>
    <meta name="description" content="Stay warm and stylish with the Navy Blue Fleece Man Hoodie by Heritage Appreals, Ludhiana. Crafted from soft fleece fabric, this hoodie offers cozy comfort, long-lasting durability, and a versatile design perfect for casual, sporty, or everyday winter wear.">
                        ...
                        <div class="shop-bred pt-35 pb-35">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Navy Blue Fleece Man Hoodies
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="pro-img">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home5" role="tabpanel"
                                    ...
                                    <img src="img/productimages/1727025637749-1000x1000.webp"
                                        class="img-fluid" alt=""></div>

                                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                                    <img src="img/productimages/1727025637749-1000x1000.webp" class="img-fluid" alt="">
                                </div>
                            ...
                            <ul class="nav" id="myTab1" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab5" data-toggle="tab" href="#home5" role="tab"
                                        ...
                                        <img src="img/productimages/1727025637749-1000x1000.webp" class="img-fluid" alt="" style="width: 110px; height: 110px;">
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-4 col-md-12 order-3 order-lg-2">
                        <div class="pro-content">
                            <span>Hoodies</span>
                            <h5 class="title">Navy Blue Fleece Man Hoodies</h5>
                            ...
                            <div class="pro-code pt-25">
                                <ul>
                                    <li>SKU: <span>FW51194881815</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    ...
                                                    <p>The Navy Blue Fleece Hoodie from Heritage Appreals, Ludhiana is a perfect blend of comfort, style, and durability. Crafted from premium fleece fabric, this hoodie offers a soft, warm feel, making it ideal for casual outings, winter layering, or relaxed indoor wear.

Its rich navy blue color exudes sophistication while remaining versatile enough to pair with jeans, track pants, or joggers effortlessly. Designed with a regular fit and full sleeves, this hoodie ensures a comfortable and relaxed silhouette suitable for all-day wear.

Manufactured with precision in Ludhiana, India, this hoodie reflects high-quality stitching, long-lasting durability, and attention to detail. Lightweight yet cozy, it provides warmth without compromising on style, making it a wardrobe essential for men looking for practical winter wear.

The plain design adds timeless appeal, making it easy to layer or accessorize. Suitable for casual wear, travel, college, or outdoor activities, this hoodie is a must-have for every wardrobe. Available in all sizes and ready in stock, it combines functionality with modern fashion.</div>
                                            </div>
                                            <!-- <div class="col-md-6">
                                                <div class="single-content mb-40">
