...
<?php include '../../assets/body.php';?>
                        ...
                        <div class="shop-bred pt-35 pb-35">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Heavy Winter 3 Thread Cotton Fleece Sweatshirt 350 Gsm Sweatshirt For Men
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="pro-img">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                                    <img src="img/productimages/product-jpeg-1000x1000 (3).webp" class="img-fluid" alt="">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-12 order-3 order-lg-2">
                        <div class="pro-content">
                            ...
                            <h5 class="title">Heavy Winter 3 Thread Cotton Fleece Sweatshirt 350 Gsm Sweatshirt For Men</h5>
  ...
  <li>Full Sleeve Sweatshirts for Everyday Comfort</li>
                            ...
                            <div class="pro-code pt-25">
                                <ul>
                                    <li>SKU: <span>FW50758948805814</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    ...
                                                    <p>Beat the cold in style with the Heavy Winter 3-Thread Cotton Fleece Sweatshirt (350 GSM) – a premium winter essential designed to provide unmatched warmth and comfort. Proudly manufactured by Heritage Appreals, Ludhiana, this sweatshirt is crafted for bulk buyers, fashion resellers, corporate buyers, and uniform suppliers looking for reliable winterwear with high durability and finish.

Constructed with 3-thread cotton fleece, this sweatshirt offers a dense 350 GSM thickness, making it ideal for heavy winter wear. It retains heat while offering a soft brushed inner surface that feels gentle on the skin. The outer texture has a clean, structured look that pairs well with both casual and semi-formal outfits.

Its classic round neck design and full sleeves provide complete coverage and a snug fit. With availability in all sizes and colors, this sweatshirt can be customized or stocked in diverse collections – from school and college uniforms to streetwear drops and retail winter lines.

Whether you're targeting colder regions or building a premium fleecewear catalog, this product from Heritage Appreals ensures quality, comfort, and affordability in every piece.
    ...
    <p>These sweatshirts are everything we were looking for—durable, cozy, and stylish. Our customers love them.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Avni Cheema</h5>
    <p>The feedback has been amazing. Everyone mentions how premium it feels for such a great price.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Shaurya Jassal</h5>
    <p>We added these to our winter campaign, and they performed way better than expected. Absolute hit!</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Tia Sekhon</h5>
    <p>The fabric breathes well, doesn’t shrink, and fits great. It's a clear favorite in our collection.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Kabir Bansal</h5>
    <p>Excellent craftsmanship. The neck stitching and sleeve fit are particularly well done.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Meher Sidana</h5>
    <p>We’ve added this to our standard winter inventory now. It’s reliable and high-quality every time.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Yug Sangha</h5>
    <p>The build, texture, and finish are far better than similar products in the same price range.</p>
</div>
