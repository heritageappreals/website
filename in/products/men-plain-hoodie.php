                        ...
                        <div class="shop-bred pt-35 pb-35">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Mens Plain Hoodies</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="pro-img">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home5" role="tabpanel"
                                    ...
                                    <img src="img/productimages/plain-black-hoodi01.webp" class="img-fluid"
                                        alt="">
                                </div>

                                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                                    <img src="img/productimages/plain-black-hoodie02.webp" class="img-fluid"
                                        alt="">
                                </div>
                            ...
                            <ul class="nav" id="myTab1" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab5" data-toggle="tab" href="#home5" role="tab"
                                        ...
                                        <img src="img/productimages/plain-black-hoodi01.webp"
                    ...
                    <div class="col-lg-4 col-md-12 order-3 order-lg-2">
                        <div class="pro-content">
                            <span>Hoodies</span>
                            <h5 class="title">Mens Plain Hoodies</h5>
                            <div class="pro-rating pb-40">
                                ...
                                <a href="#" class="active"><i class="fas fa-star"></i></a>
                                <a href="#" class="active"><i class="fas fa-star"></i></a>
                                <a href="#" class="review">(4 customer reviews)</a>
                            </div>
                            ...
                            <div class="about-pro">
                                <ul class="mb-40">
                                    <li>Custom Hoodies Manufacturer</li>
                                    <li>Plain Fleece Hoodie Wholesale</li>
                                    <li>Custom Winterwear Hoodie</li>
                                    <li>Stylish Hoodie For Men</li>
                                    <li>Full sleeve Hoodies</li>
                                </ul>
                                <p>Heritage Appreals has been dedicated to blending creativity with craftsmanship to bring your unique visions to life. With a foundation built on quality, innovation, and customer satisfaction, we have proudly served individuals and businesses alike, delivering exceptional results tailored to their specific needs Manufecturer in Ludhiana, India</p>
                            </div>
                            <div class="pro-code pt-25">
                                <ul>
                                    <li>SKU: <span>FW511948803</span></li>
                                    <li>Tag: <span>Men Plain Hoodie</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="#">
                                ...
                                <div class="field">
                                    ...
                                    <select name="select">
                                        ...
                                        <option value="4">Dark Gray</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    ...
                                                    <p>Welcome to Heritage Apparels, a leading B2B custom winterwear manufacturer and hoodie supplier in India since 2020. We specialize in producing bulk fleece hoodies, custom printed hoodies, and branded winterwear for colleges, corporates, events, and resellers. Based in Ludhiana, Punjab – India’s textile hub – we combine rich industry experience with modern production capabilities to deliver high-quality, affordable winter garments.

Our 300 GSM Plain Fleece Hoodies for Men are crafted with durable, warm, and breathable fleece fabric—ideal for daily wear, event merchandise, and corporate winter uniforms. Whether you're looking for plain hoodie wholesale or custom logo hoodies in India, we offer flexible solutions tailored to your requirements. Choose from pullover or zipper hoodies with logo printing, available in various colors and sizes.

We support bulk hoodie orders with low MOQs, fast delivery, and high customization potential. Add your college logo, corporate branding, or event messaging with our in-house screen printing, embroidery, or DTG solutions. Perfect for college event hoodies, team hoodies India, and staff uniforms, our fleece hoodies combine functionality and premium look at unbeatable prices.</p>
                                                </div>
                                            </div>
                                            <!-- <div class="col-md-6">
                                                <div class="single-content mb-40">
                                ...
                                <div class="tab-pane fade" id="contact11" role="tabpanel"
                                    ...
                                    <div class="desc-content mt-60">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    <h5 class="title">Mr.Jain Enterprises </h5>
                                                    <p>I Got Best Quality For Plain hoodies for my business through the heritage
                                                        Appreals </p>
                                                </div>
                                                <div class="single-content mb-40">
                                                    <h5 class="title">JK Hosiery </h5>
                                                    <p>I Got Best Price or Quality from the Heritage Appreals.</p>
                                                </div>
                                                <div class="single-content mb-40">
                                                    <h5 class="title">Sharma and Sons Industries</h5>
                                                    <p>Received Order at the time</p>
                                                </div>
