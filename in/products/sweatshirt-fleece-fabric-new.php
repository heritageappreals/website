...
<?php include '../../assets/body.php';?>
  ...
  <li>Full Sleeve Sweatshirts for Everyday Comfort</li>
                            ...
                            <div class="pro-code pt-25">
                                <ul>
                                    <li>SKU: <span>FW51894881873</span></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-content mb-40">
                                                    ...
                                                    <p>ntroducing the Men's Fleece Sweatshirt, proudly manufactured by Heritage Appreals, Ludhiana, where quality craftsmanship meets comfort-driven design. This sweatshirt is made from premium fleece fabric, known for its soft texture, excellent insulation, and durability—making it a dependable choice for both casual wear and cold-weather layering.

The design features a regular fit that offers a comfortable and relaxed silhouette, suitable for everyday movement without feeling too loose or tight. It is available in a variety of colors to match different style preferences and comes in all essential sizes from S to XXL, ensuring a perfect fit for everyone.

Ideal for daily wear, casual outings, or even light outdoor activities, this fleece sweatshirt provides cozy warmth while maintaining a sharp, minimalistic look. The clean plain pattern and versatile styling make it easy to pair with jeans, joggers, or trousers, whether you’re at home or on the go.

Built for comfort, warmth, and timeless style, this sweatshirt by Heritage Appreals, Ludhiana is a wardrobe essential for men who value practicality with a modern edge.</div>
                                            </div>
                                            <!-- <div class="col-md-6">
                                                <div class="single-content mb-40">
                                ...
                                <div class="tab-pane fade" id="contact11" role="tabpanel"
                                    ...
                                    <div class="desc-content mt-60">
                                        <div class="row">
                                            <div class="col-md-12">                                               
    <div class="single-content mb-40">
    <h5 class="title">Kabir Sran</h5>
    <p>Stylish, warm, and lightweight — easily one of our most recommended winter pieces.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Saanvi Mahal</h5>
    <p>We used them for staff uniforms — got compliments from customers too. Looks very neat.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Reyansh Chatha</h5>
    <p>The zippers are top-notch. No catching, no skipping. They slide perfectly.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Meher Gill</h5>
    <p>We’ve sold these at multiple flea markets. They always grab attention with the premium look.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Yug Dhillon</h5>
    <p>Fits great, feels better. You can tell the stitching is done with care. Highly recommend.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Tia Purewal</h5>
    <p>Even in larger sizes, the hoodie sits well on the shoulders and sleeves. Great proportions.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Dev Heer</h5>
    <p>Our customers used these hoodies for travel, daily wear, and layering — all gave 5-star feedback.</p>
</div>

<div class="single-content mb-40">
    <h5 class="title">Avni Bajaj</h5>
    <p>Great color variety, dependable zips, and soft interiors — a complete package.</p>
</div>
